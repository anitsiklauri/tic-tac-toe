...
class MainActivity2 : AppCompatActivity(), android.view.View.OnClickListener {
    ...
    private lateinit var ann2:TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var vai1 = findViewById<TextView>(R.id.vai1)
        var vai2 =findViewById<TextView>(R.id.vai2)
        vai1.text="$pl1"
        vai2.text="$pl2"
        ...
        ann1=findViewById(R.id.ann1)
        ann2=findViewById(R.id.ann2)
